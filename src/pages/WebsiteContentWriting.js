                    ...
                    <div className="row pt-5">
                        ...
                        <div className="col-28">
                            <div className="form pt-4" ref={topSectionRef}>
                                ...
                                <BannerForm PageNameTracking={'[Website Content Writing Page Banner Form]'} />
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div className="writing-section py-5">
                <div className="container">
                    <div className="row align-items-center">
                        <div className="col-md-6">
                            <h6 className='fs_32 fw_700'>Amazon Publisher Pros: Quality Web Content For Your Brand</h6>
                            <p className='fs_16 fw_400'>Your brand's image matters from the get-go. Our expert writers are here to create captivating content that grabs your audience's attention and keeps them coming back. If you're looking to increase website traffic and give your site a professional touch, let our team work their magic.</p>
            ...
            <div className='goal-section py-5'>
                <div className="container">
                    <div className="row align-items-center">
                        ...
                        <p className='text-center fw_300 fs_16'>We aim to boost your website’s success by creating amazing content for you!</p>
                        <div className="col-md-4">
                            <div className="card mb-lg-0 mb-3 box__shadow bg-transparent border-0">
                                <div className="card-body text-center">
                                    <img src={writer} alt="" className='img-fluid' />
                                    <h4 className='fw_700 fs_20'>Excellent Website Content</h4>
                                    <h6 className='fs_16 fw_400'>Our expert writers know how to capture readers' attention with their words. We also make sure that the content on your Amazon Publisher Pros website is search engine-friendly to improve your website's ranking.</h6>
                                </div>
                            </div>
                        </div>
                        <div className="col-md-4">
                            <div className="card mb-lg-0 mb-3 box__shadow bg-transparent border-0 ">
                                <div className="card-body text-center">
                                    ...
                                    <h4 className='fw_700 fs_20'>Quick Service</h4>
                                    <h6 className='fs_16 fw_400'>Our skilled writers are committed to delivering content ahead of schedule. This allows us to get feedback from our clients and make any necessary revisions promptly.</h6>
                                </div>
                            </div>
                        </div>
                        <div className="col-md-4">
                            <div className="card mb-lg-0 mb-3 box__shadow bg-transparent border-0 ">
                                <div className="card-body text-center">
                                    ...
                                    <h4 className='fw_700 fs_20'>Satisfying Our Clients</h4>
                                    <h6 className='fs_16 fw_400'>We prioritize keeping our clients happy. We discuss all content with them before completing it. If a client isn't satisfied with a piece of content, we'll revise it to meet their requirements.</h6>
                                </div>
                            </div>
                        </div>
                    </div>
