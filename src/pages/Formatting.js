                    ...
                    <div className="row pt-5">
                        <div className="col-45">
                            ...
                            <p className='fs_16 fw_400 text-white'>Are you struggling with formatting your
                                ...
                                your book formatted right to avoid
                                rejections on publishing platforms.
                                Let us handle the formatting details
                                while you concentrate on your writing.
                            </p>
                        ...
                        <div className="col-28">
                            <div className="form pt-4" ref={topSectionRef}>
                                ...
                                <BannerForm PageNameTracking={'[Formatting Page Banner Form]'} />
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div className="container">
                    <div className="row justify-content-center">
                        ...
                        <div className="col-md-3 text-center mb-lg-0 mb-3">
                            ...
                            <h6 className='fs_16  px-lg-3'>We provide professional E-book writing services.</h6>
                        </div>
                        <div className="col-md-3 text-center mb-lg-0 mb-3">
                            <img src={service1} alt="" className='img-fluid' />
            ...
            <div className="writing-section py-5">
                <div className="container">
                    <div className="row align-items-center">
                        <div className="col-md-6">
                            <h5 className="fs_23 fw_700">Are you ready to <span className="text__orange"> publish your book</span>, or are you stuck in a tricky situation with your writing? We’re here to guide you.</h5>
                            <h6 className='fs_32 fw_700'>AT GOLD <span className="text__orange"> GHOSTWRITERS</span>, WE PROVIDE A <span className="text__orange">ONE-STOP SOLUTION</span> FOR ALL YOUR BOOK NEEDS:</h6>
                ...
                <div class="timeline">
                    <div class="inner left">
                        <div class="content">
                            ...
                            <p className='fs_16 fw_400'>Struggling with foreign book formatting rules? No worries. The experts at Amazon Publisher Pros know how to format books just right, following international standards. We'll give your book a consistent and attractive design to make it shine.</p>
                        </div>
                    </div>
                    <div class="inner right">
                        <div class="content">
                            <h2 className='fs_24 fw_700'>Fixing Formatting Errors</h2>
                            <p className='fs_16 fw_400'>Our experts ask you for your draft, so we can spot and fix any formatting mistakes, ensuring your book looks its best when published.</p>
                        </div>
                    </div>
                    <div class="inner left">
                        <div class="content">
                            <h2 className='fs_24 fw_700'>Using Expert Tools</h2>
                            <p className='fs_16 fw_400'>We're well-versed in the latest tools and techniques for formatting, making the entire process smooth and efficient.</p>
                        </div>
                    </div>
                    <div class="inner right">
                        <div class="content">
