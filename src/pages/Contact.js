                ...
                <div className="container pt-5 pb-3 mt-5">
                    <div className="row pt-5">
                        <div className="col-45">
                            <h3 className='text__shadow fs_23 fw_700 text-white'>IMAGINE WHAT OUR</h3>
                            <h1 className='text__shadow fs_40 text-white fw_700'> <span className='text__orange'>BOOK PUBISHING SERVICE</span> </h1>
                            <h5 className='fs_21 fw_400 text-white'>Can Help You Accomplish</h5>
                            <h5 className='fs_21 fw_400 text-white'>With A Book</h5>
                            <h5 className='fs_21 fw_400 text-white'>WHAT YOU GAIN:</h5>
                            <ul className='list-unstyled'>
                                <li className='fs_15 fw_400 text__green'><FaCheckDouble className='fs_20 text-white' /> Recognition, Fame And Credibilty</li>
                                <li className='fs_15 fw_400 text__green'><FaCheckDouble className='fs_20 text-white' /> Authority In Your Area of Expertise</li>
                                <li className='fs_15 fw_400 text__green'><FaCheckDouble className='fs_20 text-white' /> Increase In Sales For Your Business</li>
                                <li className='fs_15 fw_400 text__green'><FaCheckDouble className='fs_20 text-white' /> More Career Growth Opportunities</li>
                                <li className='fs_15 fw_400 text__green'><FaCheckDouble className='fs_20 text-white' /> A Steady, Reliable Additional Income</li>
                                <li className='fs_15 fw_400 text__green'><FaCheckDouble className='fs_20 text-white' /> Inspire Other With Your Work</li>
                                <li className='fs_15 fw_400 text__green'><FaCheckDouble className='fs_20 text-white' /> We Can Write, Design and Publish your book in less than 30 days!</li>
                            </ul>
                        ...
                        <div className="col-28">
                            <div className="form pt-4" ref={topSectionRef}>
                                ...
                                <BannerForm PageNameTracking={'[Contact Page Banner Form]'} />
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div className='book-publish py-5'>
                <div className="container">
                    <div className="text-center">
                        ...
                        <p className='fs_16 px_150 fw_300 text__black'>Are you thinking about writing a book? We’re here to make it easy for you. Amazon Publisher
                ...
                <div className="position-relative">
                    <div className="container">
                        <div className="row">
                            ...
                            <h5 className='fs_20 fw_600 text-center text__orange'>Simply Fill Out the Form Below</h5>
                            <ContactForm PageNameTracking={'Contact Page Contact Form'} />
                        </div>
                    </div>
                </div>
            </div>
