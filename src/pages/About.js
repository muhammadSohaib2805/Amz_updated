...
import about from '../asset/images/refine-your-journey.png'
    ...
    return (
        ...
        <MetaTitleDesc/>
                ...
                <div className="container pt-5 pb-3 mt-5">
                    <div className="row pt-5">
                        <div className="col-45">
                            <h3 className='text__shadow fs_40 fw_700 text-white'><span className='text__orange text-uppercase'>About Us</span> </h3>
                            <p className='fs_21 lh_1 fw_400 text-white'>With over 15 years of experience in the publishing industry, our team is ready to guide you through your journey, from writing to marketing. We’re so confident that we’ll provide you with an excellent publishing experience until your satisfaction. We provide customized packages for every need and budget – whether you’re an aspiring author or seasoned writer looking for a new publisher, we can’t wait to help you succeed.
                            </p>
                        ...
                        <div className="col-28">
                            <div className="form pt-4" ref={topSectionRef}>
                                ...
                                <BannerForm PageNameTracking={'[About Page Banner Form]'} />
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div className="container">
                <div className="row pt-5 align-items-center pb-5">
                    <div className="col-md-6 d-flex justify-content-end">
                        <img src={about} alt="" />
                    </div>
                    <div className="col-md-6">
                        <h2 className='fs_36 fw_600'>Refine Your Book Writing Journey With Us.</h2>
                        <p className='fs_16 fw_400'>At Amazon Publishing Pros, we are the biggest supporters of dreamers and storytellers.
                            Be it an autobiography, a work of fiction, or based on a historical event, our job is to bring your vision to life in
                            the form of an excellent written and published book. Amazon Publishing Pros is a team of experienced book enthusiasts who
                            excel in various genres. We have a market reputation of releasing thousands of successful publications – diligently written, edited, designed, and published.
                            That’s not all; many of our clients have become best-selling authors with the help of our professional expertise.</p>
                    </div>
                </div>
            </div>
            <div className='bookslider py-5'>
                <div className="container">
                    <div className="text-center">
                        ...
                        <p className='fs_16  px_lg_150 fw_600'>We've completed lots of different projects, from small to big. Our clients include regular folks, <br /> experts,
                                    ...
                                    <div className="p_66_40">
                                        <div className="row align-items-center">
                                            ...
                                            <div className="col-md-6 d-flex justify-content-center">
                                                <button onClick={openLiveChat} style={{padding:'12px 24px'}} className='btn border-0 bg__black text-white rounded-pill fs_25 fw_600'>CHAT NOW</button>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                ...
                <div className="position-relative">
                    <div className="container">
                        <div className="row">
                            ...
                            <ContactForm PageNameTracking={'About Page Contact Form'} />
                        </div>
                    </div>
                </div>
            </div>
